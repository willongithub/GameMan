/*************************************************************************
Title:    GameMan Console Header File
...
//byte pad_l(byte column, byte buffer[][MAX_PAGES]);
byte ball_move(byte column, byte row, byte buffer[][MAX_PAGES]);
//byte ball_up_r(byte column, byte row, byte buffer[][MAX_PAGES]);
//byte ball_up_l(byte column, byte row, byte buffer[][MAX_PAGES]);
//byte ball_down_r(byte column, byte row, byte buffer[][MAX_PAGES]);
//byte ball_down_l(byte column, byte row, byte buffer[][MAX_PAGES]);
...
byte move_show(byte x_axis, y_axis);
byte get_result(byte board[BOARDSIZE][BOARDSIZE]);
byte write_x(byte x_axis, y_axis);
byte write_o(byte x_axis, y_axis);
byte write_pointer(byte text_page , byte text_column);
byte pointer_clear(byte text_page , byte text_column);
